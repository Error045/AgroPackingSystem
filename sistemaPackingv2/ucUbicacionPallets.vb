...
Imports System.Globalization ' Necesario para el manejo seguro de decimales

Public Class ucUbicacionPallets
    ...
    Private Sub ucUbicacionPallets_Load(sender As Object, e As EventArgs) Handles MyBase.Load
