...
Public Class ucValidacionPallet
    ...
    Private Sub ucValidacionPallet_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Public Sub CargarPalletsDisponibles()
        Try
            ...
            Dim sql As String =
                ...
                "WHERE e.estados_procesos_pallets_id = 1 AND a.estados_contenedores_id = 9;"
            ...
            If Not Me.DesignMode Then
                Try
                    ...
                    Dim sql As String =
                        ...
                        "JOIN tipos_contenedores d ON b.tipos_contenedores_id = d.id " &
                        "JOIN procesos_paletizado e ON a.procesos_paletizado_id = e.id " &
                        "WHERE a.id = @id AND e.estados_procesos_pallets_id = 1 AND a.estados_contenedores_id = 9;"
